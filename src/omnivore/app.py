...
def create_app() -> Flask:
    ...
    # Register blueprints
    from omnivore.api.instruments import bp as instruments_bp
    from omnivore.api.jobs import bp as jobs_bp
    from omnivore.api.models import bp as models_bp
    from omnivore.api.predictions import bp as predictions_bp
    ...
    from omnivore.routes.dashboard import bp as dashboard_bp
